...
int64 nChainStartTime = 1405930049;
...
const string strMessageMagic = "DojeCoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 100800;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_BN_PROOF_OF_STAKE;

         if(nHeight < 1 * YEARLY_BLOCKCOUNT) nRewardCoinYear = 4 * MAX_BN_PROOF_OF_STAKE;
    else if(nHeight < 2 * YEARLY_BLOCKCOUNT) nRewardCoinYear = 3 * MAX_BN_PROOF_OF_STAKE;
    else if(nHeight < 3 * YEARLY_BLOCKCOUNT) nRewardCoinYear = 2 * MAX_BN_PROOF_OF_STAKE;
    else nRewardCoinYear = 1 * MAX_BN_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UnionCoin
    bool fStrictPayToScriptHash = true; // Always active in UnionCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UnionCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "UnionCoin V2.0 2014-07-21";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x72d24ed8fd042601c8d1bb9b91caf47bf5f1a4aa46a73d269bd938893cfbafce"));
...
unsigned char pchMessageStart[4] = { 0xd5, 0xdb, 0xce, 0xfa };
